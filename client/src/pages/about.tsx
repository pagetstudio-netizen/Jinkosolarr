    ...
    <div className="flex flex-col min-h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="space-y-4">
          <h2 className="text-xl font-bold" style={{ color: "#007054" }}>Qui sommes-nous ?</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold" style={{ color: "#007054" }}>Innovation & Durabilité</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold" style={{ color: "#007054" }}>Sécurité et Fiabilité</h2>
          <p className="text-gray-600 leading-relaxed">
